...
useGSAP(()=>{
  timeline.to("#yellow-box", {x: 100, duration: 1});
  timeline.to("#yellow-box", {y: 50, duration: 1});
  timeline.to("#yellow-box", {opacity: 0, duration: 1});
},[])
  ...
  return (
    <main>
      ...
      <div className="mt-20 space-y-10">
        <button onClick={() => {if(timeline.paused()) timeline.play();
           else timeline.pause();}}>Play/Pause</button>
